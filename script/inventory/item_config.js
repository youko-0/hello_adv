...
const ItemConfig = {
    ...
    item_mural_nezhanaohai: {
        name: "哪吒闹海",
        type: ItemType.CLUE,
        icon: ResMap.icon_item_mural_nezhanaohai,
    ...
    item_mural_ziwenguitian: {
        name: "自刎归天",
        type: ItemType.CLUE,
        icon: ResMap.icon_item_mural_ziwenguitian,
    ...
    item_mural_lianhuatuosheng: {
        name: "莲花托生",
        type: ItemType.CLUE,
        icon: ResMap.icon_item_mural_lianhuatuosheng,
    ...
    item_mural_jianzaoshenmiao: {
        name: "???",
        type: ItemType.CLUE,
        icon: ResMap.icon_item_mural_jianzaoshenmiao,
    ...
    item_mural_zhuzaosuxiang: {
        name: "???",
        type: ItemType.CLUE,
        icon: ResMap.icon_item_mural_zhuzaosuxiang,
    ...
    item_mural_lijingsb: {
        name: "???",
        type: ItemType.CLUE,
        icon: ResMap.icon_item_mural_lijingsb,
