...
const GalleryConfig = {
    ...
    cg_lingzhu_yu_long_1: {
        ...
        resId: ResMap.pic_gallery_cg_lingzhu_yu_long_1,
        desc: '灵珠与龙初遇。',
        locked: { desc: '尚未解锁' },
    },
    cg_zhaoyun_musan_1: {
    ...
    cg_yunbing_chujian_1: {
        ...
        resId: ResMap.pic_gallery_cg_yunbing_chujian_1,
        desc: '云冰初见。',
        locked: { desc: '尚未解锁' },
    },
    cg_yunbing_chujian_2: {
        ...
        resId: ResMap.pic_gallery_cg_yunbing_chujian_2,
        desc: '云冰初见。',
        locked: { desc: '尚未解锁' },
    },
    cg_aobing_zijin_1: {
    ...
    scene_nezha_temple_dark: {
        ...
        category: GalleryCategory.APPRECIATION, sub: GallerySub.SCENE,
        aspect: '16:9', sortIndex: 1,
        resId: ResMap.pic_gallery_scene_nezha_temple_dark,
        desc: '黑哪吒庙。',
        locked: { desc: '尚未解锁' },
    },
    scene_dragon_temple: {
        ...
        category: GalleryCategory.APPRECIATION, sub: GallerySub.SCENE,
        aspect: '16:9', sortIndex: 2,
        resId: ResMap.pic_gallery_scene_dragon_temple,
        desc: '龙王庙。',
        locked: { desc: '尚未解锁' },
    },
    scene_dragon_palace: {
        ...
        category: GalleryCategory.APPRECIATION, sub: GallerySub.SCENE,
        aspect: '16:9', sortIndex: 3,
        resId: ResMap.pic_gallery_scene_dragon_palace,
        desc: '龙王行宫。',
        locked: { desc: '尚未解锁' },
    },
    ...
    // ════════ 人物 - 立绘 ════════
    portrait_lingzhuzi: {
        name: '灵珠子', type: GalleryType.IMAGE,
    ...
    portrait_xiaolongshen: {
        name: '小龙神', type: GalleryType.IMAGE,
        category: GalleryCategory.CHARACTER, sub: GallerySub.PORTRAIT,
        aspect: '3:4', sortIndex: 1,
        resId: ResMap.pic_gallery_portrait_xiaolongshen,
        desc: '小龙神。',
        locked: { desc: '尚未解锁' },
    },
    portrait_liyunxiang: {
        name: '李云祥', type: GalleryType.IMAGE,
        category: GalleryCategory.CHARACTER, sub: GallerySub.PORTRAIT,
        aspect: '3:4', sortIndex: 2,
        resId: ResMap.pic_gallery_portrait_liyunxiang,
        desc: '李云祥。',
        locked: { desc: '尚未解锁' },
    },
    portrait_aobing: {
        name: '敖丙', type: GalleryType.IMAGE,
        category: GalleryCategory.CHARACTER, sub: GallerySub.PORTRAIT,
    ...
    avatar_shaonian_kasha: {
        ...
        resId: ResMap.icon_gallery_avatar_shaonian_kasha,
        desc: '少年喀莎。',
        locked: { desc: '尚未解锁' },
    },
    avatar_kasha: {
    ...
    avatar_qingnian_lijinxiang: {
        ...
        resId: ResMap.icon_gallery_avatar_qingnian_lijinxiang,
        desc: '青年李金祥。',
        locked: { desc: '尚未解锁' },
    },
    avatar_lijinxiang: {
    ...
    avatar_diyong_furen: {
        ...
        resId: ResMap.icon_gallery_avatar_diyong_furen,
        desc: '地涌夫人。',
        locked: { desc: '尚未解锁' },
    },
    ...
    memory_lingzhu_yu_long: {
        ...
        resId: ResMap.pic_gallery_memory_lingzhu_yu_long,
        desc: '灵珠与龙，初遇之缘。',
        locked: { desc: '尚未解锁' },
    },
    memory_zhaoyun_musan: {
        ...
        resId: ResMap.pic_gallery_memory_zhaoyun_musan,
        desc: '朝云暮散，聚散匆匆。',
        locked: { desc: '尚未解锁' },
    },
    // 第二世
    memory_nezha_naohai: {
        ...
        resId: ResMap.pic_gallery_memory_nezha_naohai,
        desc: '哪吒闹海，搅动东海。',
        locked: { desc: '尚未解锁' },
    },
    // 第三世
    memory_longshen_quqin: {
        ...
        resId: ResMap.pic_gallery_memory_longshen_quqin,
        desc: '龙神娶亲，红妆铺海。',
        locked: { desc: '尚未解锁' },
    },
    memory_yunbing_chujian: {
        ...
        resId: ResMap.pic_gallery_memory_yunbing_chujian,
        desc: '云冰初见，前世今生。',
        locked: { desc: '尚未解锁' },
    },
    memory_three_dates: {
        ...
        resId: ResMap.pic_gallery_memory_three_dates,
        desc: '三个约会，情愫渐生。',
        locked: { desc: '尚未解锁' },
    },
    memory_lijing_tanhua: {
        ...
        resId: ResMap.pic_gallery_memory_lijing_tanhua,
        desc: '李靖谈话，父子心结。',
        locked: { desc: '尚未解锁' },
    },
    memory_aolie_laifang: {
        ...
        resId: ResMap.pic_gallery_memory_aolie_laifang,
        desc: '敖烈来访，旧人重逢。',
        locked: { desc: '尚未解锁' },
    },
    memory_longzhu_beihui: {
        ...
        resId: ResMap.pic_gallery_memory_longzhu_beihui,
        desc: '龙珠被毁，劫数将至。',
        locked: { desc: '尚未解锁' },
    },
    memory_aobing_zijin: {
        ...
        resId: ResMap.pic_gallery_memory_aobing_zijin,
        desc: '敖丙自尽，魂归沧海。',
        locked: { desc: '尚未解锁' },
    },
